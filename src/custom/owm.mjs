...
/**
 * Create OpenWeatherMap helpers
 * @param {object} dependencies - Dependencies
 * @param {function} dependencies.fetch - Fetch function
 * @param {function} dependencies.log - Log function
 * @returns {object} Helpers
 */
export function createOwmHelpers({ fetch, log }) {
    return {
        /**
         ...
         */
        async getWeatherData(lat, lon, units) {
...
// Export getWeatherData as a named export for compatibility with consumers and tests
